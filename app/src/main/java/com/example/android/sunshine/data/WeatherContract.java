...
public class WeatherContract {
  ...
  // use CONTENT_AUTHORITY to create the base of all URIs which apps will use to connect to the
  // content provider
  public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

  // possible paths (append to base content URI for possible URIs)
  ...
  public static final class LocationEntry implements BaseColumns {
    ...
    public static final String CONTENT_TYPE_ITEM = "vnd.android.cursor.item/" + CONTENT_AUTHORITY + "/" + PATH_LOCATION;
